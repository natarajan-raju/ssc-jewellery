...
export default function AdminLogin() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-[#0A192F] via-[#112240] to-[#0A192F]">
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-2xl w-full max-w-sm shadow-2xl animate-slide-in relative z-10">
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div className="relative group">
                        ...
                        />
                        <Lock className="absolute right-3 top-3.5 text-gray-500 w-5 h-5 group-hover:text-gray-400 transition-colors" />
                    </div>
